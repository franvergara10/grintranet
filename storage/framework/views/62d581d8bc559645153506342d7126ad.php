...
<?php $__env->startSection('title', isset($template) ? 'Editar Plantilla' : 'Nueva Plantilla'); ?>

<?php $__env->startSection('content'); ?>
<div class="header-actions">
    <h1><?php echo e(isset($template) ? 'Editar Plantilla' : 'Crear Nueva Plantilla'); ?></h1>
    <a href="<?php echo e(route('schedule-templates.index')); ?>" class="btn-secondary">Volver</a>
</div>

<div class="card" style="padding: 20px;">
    <form id="templateForm" method="POST" action="<?php echo e(isset($template) ? route('schedule-templates.update', $template->id) : route('schedule-templates.store')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" value="<?php echo e(old('name', $template->name ?? '')); ?>" required>
        </div>

        <div class="form-group">
            <label for="description">Descripción (Opcional)</label>
            <textarea name="description" id="description" class="form-control"><?php echo e(old('description', $template->description ?? '')); ?></textarea>
        </div>
            ...
            <div class="days-checkboxes">
                ...
                <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="checkbox-label">
                        <input type="checkbox" name="active_days[]" value="<?php echo e($index + 1); ?>" onchange="updateGrid()"
                            <?php echo e(in_array($index + 1, $activeDays) ? 'checked' : ''); ?>>
                        <?php echo e($day); ?>
...
<script>
    let slotCount = 0;
    const existingSlots = <?php echo json_encode($template->timeSlots ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\grintranet\resources\views/schedule_templates/form.blade.php ENDPATH**/ ?>