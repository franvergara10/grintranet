<?php $__env->startSection('title', 'Mis Horarios Personales'); ?>

<?php $__env->startSection('content'); ?>
    <div class="page-header">
        <h1 class="page-title">Mis Horarios Personales</h1>
        <div>
            <a href="<?php echo e(route('personal-schedules.create')); ?>" class="btn btn-primary">
                + Nuevo Horario
            </a>
        </div>
    </div>
                ...
                <div class="card shadow-hover" style="display: flex; flex-direction: column; justify-content: space-between;">
                    <div>
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1rem;">
                            <h3 style="font-weight: 600; font-size: 1.25rem;"><?php echo e($schedule->scheduleTemplate->name); ?></h3>
                            <span class="badge badge-success">Personalizado</span>
                        </div>
                        <p style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 1rem;">
                            <?php echo e($schedule->scheduleTemplate->description ?? 'Sin descripción'); ?>

                        </p>
                        <div style="font-size: 0.85rem; color: var(--text-muted);">
                            <strong>Días:</strong> <?php echo e(implode(', ', $schedule->scheduleTemplate->active_days ?? [])); ?>

                        </div>
                    </div>

                    <div style="margin-top: 1.5rem; display: flex; gap: 0.5rem;">
                        <a href="<?php echo e(route('personal-schedules.show', $schedule)); ?>" class="btn"
                            style="flex: 1; background: rgba(16, 185, 129, 0.1); color: #10b981; text-align: center; border: 1px solid #10b981;">
                            Ver Horario
                        </a>
                        <a href="<?php echo e(route('personal-schedules.edit', $schedule)); ?>" class="btn"
                            style="flex: 1; background: rgba(56, 189, 248, 0.1); color: var(--primary); text-align: center; border: 1px solid var(--primary);">
                            Editar
                        </a>
                        <form action="<?php echo e(route('personal-schedules.destroy', $schedule)); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mgonpor116\Desktop\grintranet\resources\views/personal_schedules/index.blade.php ENDPATH**/ ?>