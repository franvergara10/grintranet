...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group" style="padding: 1rem; border: 1px solid var(--border); border-radius: 0.5rem; background: rgba(0,0,0,0.1);">
            <label for="password" style="margin-bottom: 0;">Cambiar Contraseña (Opcional)</label>
            <p style="font-size: 0.8rem; color: var(--text-muted); margin-bottom: 1rem;">Deja en blanco para mantener la actual.</p>
            
            <input type="password" name="password" id="password" placeholder="Nueva contraseña" style="margin-bottom: 1rem;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\usuarios\resources\views/users/edit.blade.php ENDPATH**/ ?>