...
<?php $__env->startSection('title', 'AulaPass - Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
                    ...
                    <div class="grid grid-cols-2 gap-4 w-full lg:w-auto">
                        <div class="bg-blue-500/10 border border-blue-500/20 rounded-xl px-4 py-3 min-w-[140px]">
                            ...
                            <div class="flex items-baseline gap-1">
                                <span
                                    class="text-2xl font-black text-blue-700 dark:text-blue-200"><?php echo e($stats['active_count']); ?></span>
                        ...
                        <div class="bg-indigo-500/10 border border-indigo-500/20 rounded-xl px-4 py-3 min-w-[140px]">
                            ...
                            <div class="flex items-baseline gap-1">
                                <span
                                    class="text-2xl font-black text-indigo-700 dark:text-indigo-200"><?php echo e($stats['today_count']); ?></span>
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                        ...
                        <div class="flex gap-2 w-full sm:w-auto">
                            ...
                            <a href="<?php echo e(route('aula.monitor')); ?>"
                            ...
                            <a href="<?php echo e(route('aula.history')); ?>"
                                class="p-2.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                                title="Historial">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div id="student-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="student-card group relative bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 flex flex-col justify-between"
                        data-group-id="<?php echo e($student->group_id); ?>" data-id="<?php echo e($student->id); ?>"
                        data-search="<?php echo e(strtolower($student->name . ' ' . $student->last_name)); ?>" style="display: none;">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center gap-3">
                                <div
                                    ...
                                    <?php echo e(substr($student->name, 0, 1)); ?><?php echo e(substr($student->last_name ?? '', 0, 1)); ?>

                                </div>
                                <div class="overflow-hidden">
                                    <h3 class="text-sm font-bold text-gray-900 dark:text-gray-100 truncate"
                                        title="<?php echo e($student->name); ?> <?php echo e($student->last_name); ?>">
                                        <?php echo e($student->name); ?> <?php echo e($student->last_name); ?>

                                    </h3>
                                    <span class="text-xs text-gray-400 dark:text-gray-500 truncate block">
                                        <?php echo e($student->groupRel?->course ?? ''); ?> <?php echo e($student->groupRel?->name ?? ''); ?>
                        ...
                        <div class="mt-auto">
                                ...
                                <div class="space-y-3">
                                    <div
                                        ...
                                        <div class="text-2xl font-mono font-bold text-amber-600 dark:text-amber-400 timer"
                                            data-start="<?php echo e($activePass->start_time->timestamp); ?>">
                                            00:00
                                        </div>
                                    </div>
                                    <button onclick="endPass(<?php echo e($activePass->id); ?>)"
                            ...
                            <?php else: ?>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <button onclick="createPass(<?php echo e($student->id); ?>, 'Baño')"
                                    ...
                                    <button onclick="createPass(<?php echo e($student->id); ?>, 'Agua')"
                                    ...
                                    <button onclick="createPass(<?php echo e($student->id); ?>, 'Taquilla')"
                                    ...
                                    <button onclick="promptCustomReason(<?php echo e($student->id); ?>)"
    ...
    <script>
        ...
        async function createPass(studentId, reason) {
            try {
                const res = await fetch('<?php echo e(route("aula.store")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        async function returnAll() {
            ...
            try {
                const res = await fetch('<?php echo e(route("aula.return-all")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\grintranet\resources\views/aula/dashboard.blade.php ENDPATH**/ ?>