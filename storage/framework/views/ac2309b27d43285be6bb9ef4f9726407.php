...
<?php $__env->startSection('title', 'Crear Grupo - Gestor de Usuarios'); ?>
    ...
    <div class="card" style="max-width: 600px;">
        <form action="<?php echo e(route('groups.store')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="course" id="course" value="<?php echo e(old('course')); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" required placeholder="Ej: 1º A, 2º B...">
            ...
            <div class="form-group">
                ...
                <select name="tutor_id" id="tutor_id">
                    ...
                    <?php $__currentLoopData = $tutors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tutor->id); ?>" <?php echo e(old('tutor_id') == $tutor->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\grintranet\usuarios_v4\usuarios\resources\views/groups/create.blade.php ENDPATH**/ ?>