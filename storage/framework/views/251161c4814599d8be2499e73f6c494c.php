                ...
                <ul class="nav-links">
                    ...
                    <li>
                        <a href="<?php echo e(route('personal-schedules.index')); ?>"
                            class="nav-link <?php echo e(request()->routeIs('personal-schedules.*') ? 'active' : ''); ?>">
                            Mi Horario
                        </a>
                    </li>
                    <li>
...
</html><?php /**PATH C:\Users\mgonpor116\Desktop\grintranet\resources\views/layouts/app.blade.php ENDPATH**/ ?>